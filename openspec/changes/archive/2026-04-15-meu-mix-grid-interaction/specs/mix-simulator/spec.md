...
- **THEN** o card exibe borda `primary-700`, badge laranja "Xg" no canto superior esquerdo, e o selo paraibano (se aplicável) no canto superior direito
...
- **THEN** o ingrediente é removido do mix (grams → 0); card volta ao estado padrão sem borda e sem badge
